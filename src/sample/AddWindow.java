...
//
//                Tournament findSample=new Tournament(tourName.getText(),tourType.getText(), new Person(tourWinnerFirst.getText(),tourWinnerLast.getText(),
//                tourWinnerMiddle.getText()),
...
//        paneW.getChildren().addAll(tourWinnerLa,tourWinnerFirst,tourWinnerLast,tourWinnerMiddle);
